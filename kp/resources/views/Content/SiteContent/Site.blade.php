...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url({{asset('Site/images/industrial_hero_1.jpg')}});">
        <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
                <div class="col-lg-7 text-center col-sm-12 element-animate">
                    ...
                    <p class="mb-5 w-75">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias iste ipsa
                        excepturi nostrum sequi molestias?</p>
                </div>
            </div>
        </div>
    </div>

    <div class="slider-item" style="background-image: url({{asset('Site/images/industrial_hero_2.jpg')}});">
        <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
                <div class="col-lg-7 text-center col-sm-12 element-animate">
                    <div class="btn-play-wrap mx-auto">
                    ...
                    <p class="mb-5 w-75">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae fuga, hic
                        quae molestias aperiam deserunt!</p>
                </div>
            </div>
        </div>
                ...
                <div class="scaling-image h-100">
                    <div class="frame h-100">
                        <div class="feature-img-bg h-100"
                            style="background-image: url({{asset('Site/images/industrial_feature_1.jpg')}});"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center mb-5">
            <div class="col-lg-7 order-md-2">
                <div class="scaling-image">
                    <div class="frame"><img src="{{asset('Site/images/industrial_featured_img_1.jpg')}}"
                            alt="Free template by Free-Template.co" class="img-fluid"></div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-lg-7 order-md-1">
                <div class="scaling-image">
                    <div class="frame"><img src="{{asset('Site/images/industrial_featured_img_2.jpg')}}"
                            alt="Free template by Free-Template.co" class="img-fluid"></div>
                </div>
            </div>
        ...
        <div class="row no-gutters">
            <div class="col-md-4 element-animate">
                <a href="project-single.html" class="link-thumbnail">
                    ...
                    <img src="{{asset('Site/images/industrial_img_1.jpg')}}" alt="Free template by Free-Template.co"
                        class="img-fluid">
                </a>
            </div>
            <div class="col-md-4 element-animate">
                <a href="project-single.html" class="link-thumbnail">
                    ...
                    <span class="ion-plus icon"></span>
                    <img src="{{asset('Site/images/industrial_img_2.jpg')}}" alt="Free template by Free-Template.co"
                        class="img-fluid">
                </a>
            </div>
            <div class="col-md-4 element-animate">
                <a href="project-single.html" class="link-thumbnail">
                    ...
                    <span class="ion-plus icon"></span>
                    <img src="{{asset('Site/images/industrial_img_3.jpg')}}" alt="Free template by Free-Template.co"
                        class="img-fluid">
                </a>
            </div>
            <div class="col-md-4 element-animate">
                <a href="project-single.html" class="link-thumbnail">
                    <h3>Stacks Design</h3>
                    <span class="ion-plus icon"></span>
                    <img src="{{asset('Site/images/industrial_img_4.jpg')}}" alt="Free template by Free-Template.co"
                        class="img-fluid">
                </a>
            </div>
            <div class="col-md-4 element-animate">
                <a href="project-single.html" class="link-thumbnail">
                    ...
                    <span class="ion-plus icon"></span>
                    <img src="{{asset('Site/images/industrial_img_5.jpg')}}" alt="Free template by Free-Template.co"
                        class="img-fluid">
                </a>
            </div>
            <div class="col-md-4 element-animate">
                <a href="project-single.html" class="link-thumbnail">
                    <h3>Banker Design</h3>
                    <span class="ion-plus icon"></span>
                    <img src="{{asset('Site/images/industrial_img_6.jpg')}}" alt="Free template by Free-Template.co"
                        class="img-fluid">
                </a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="nonloop-block-11 owl-carousel">
            <div class="item">
                <div class="block-33 h-100">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="{{asset('Site/images/person_3.jpg')}}"
                                alt="Person here"></div>
            ...
            <div class="item">
                <div class="block-33 h-100">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="{{asset('Site/images/person_2.jpg')}}"
                                alt="Person here"></div>
                        <div class="name-text align-self-center">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="media mb-4 d-md-flex d-block element-animate">
                    <a href="#" class="mr-5"><img src="{{asset('Site/images/industrial_blog_1.jpg')}}"
            ...
            <div class="col-md-6">
                <div class="media mb-4 d-md-flex d-block element-animate">
                    <a href="#" class="mr-5"><img src="{{asset('Site/images/industrial_blog_2.jpg')}}"
                            alt="Free website template by Free-Template.co" class="img-fluid"></a>
                    <div class="media-body">
                        <span class="post-meta">Feb 26th, 2018</span>
                        <h3 class="mt-2 text-black"><a href="#">How to handle any intercate custom design</a></h3>
                ...
                <div class="media mb-4 d-md-flex d-block element-animate">
                    <a href="#" class="mr-5"><img src="{{asset('Site/images/industrial_blog_3.jpg')}}"
                            alt="Free website template by Free-Template.co" class="img-fluid"></a>
                    <div class="media-body">
                        <span class="post-meta">Feb 26th, 2018</span>
                        <h3 class="mt-2 text-black"><a href="#">How to handle any intercate custom design</a></h3>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="text-white lead">Far far away, behind the word mountains, far from the countries Vokalia and
