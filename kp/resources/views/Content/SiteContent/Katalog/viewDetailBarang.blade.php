        ...
        <div class="row s_product_inner justify-content-between">
            <div class="col-lg-5 col-xl-5">
                <div class="product_slider_img">
                    <div id="vertical">
                        @if ($daftarBarang->gambar_barang == null)
                        <div data-thumb="{{asset('ImageNotFound/notFound.png')}}" style="width: 350px">
                            <img src="{{asset('ImageNotFound/notFound.png')}}" style="width: 350px" />
                        </div>
                        @else
                        <div data-thumb="{{asset('Image/'.$daftarBarang->id_barang.'/profil.jpg')}}"
                            style="width: 350px">
                            <img src="{{asset('Image/'.$daftarBarang->id_barang.'/profil.jpg')}}"
                                style="width: 350px" />
                        </div>
                        @endif
                    </div>
                ...
                <div class="s_product_text">
                    ...
                    <div class="card_area d-flex justify-content-between align-items-center">
                        <a href="https://api.whatsapp.com/send?phone=6281357260908&text=Saya%20ingin%20bertanya%20tentang%20ketersediaan%20barang%20{{$daftarBarang->nama_barang}}%20di%20toko%20ini.%20Mohon%20Bantuannya."
                            class="btn_3">Contact the seller</a>
                    </div>
                </div>
            </div>
        </div>
